...
export class MobileappComponent implements OnInit {
  ...
  dynamicDescription =
    'Discover top mobile app developers near you at Quantum IT Innovation. We offer custom mobile app development services, including cross-platform solutions. Your best mobile app development company!';
  ...
  fetchMobileProjects() {
    ...
    this.api.getMobileAppProjects().subscribe((res: any) => {
      ...
      console.log(res);
      setTimeout(() => {
        // Add a delay before hiding spinner
        this.spinner.hide();
